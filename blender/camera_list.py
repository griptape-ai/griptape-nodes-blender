...
from socket_client import health_check, get_scene_info, list_cameras
...
"""
            ...
            error_msg = f"Failed to fetch enhanced camera data: {str(e)}"
            ...
            if "focal_length" in camera:
                ...
                formatted_camera = {
                    ...
                    "depth_of_field": {
                        ...
                        "focus_distance": round(camera.get("dof_focus_distance", 10.0), 2) if camera.get("dof_focus_distance") else None,
                        "f_stop": round(camera.get("dof_aperture_fstop", 2.8), 2) if camera.get("dof_aperture_fstop") else None
                    },
                    
                    # Shift and composition
                    "shift": {
                        "x": round(camera.get("shift_x", 0.0), 3),
                        "y": round(camera.get("shift_y", 0.0), 3)
                    },
